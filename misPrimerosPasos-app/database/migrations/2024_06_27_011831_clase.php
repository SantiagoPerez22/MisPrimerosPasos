...
class Clase extends Migration
{
    public function up()
    {
        Schema::create('clase', function (Blueprint $table) {
            ...
            $table->foreign('id_profesor')->references('id')->on('cuentas');
            $table->foreign('id_asistente1')->references('id')->on('cuentas');
            $table->foreign('id_asistente2')->references('id')->on('cuentas');
