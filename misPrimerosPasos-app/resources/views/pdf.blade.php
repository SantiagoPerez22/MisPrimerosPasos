...
<div class="card border-0">
    ...
    <div class="card-body">
        @if(!$datos->isEmpty())
        <p><strong>Nombre del Alumno:</strong> {{ $datos->first()->alumno->nombre1 }} {{ $datos->first()->alumno->nombre2 }} {{ $datos->first()->alumno->apellido1 }} {{ $datos->first()->alumno->apellido2 }}</p>
        ...
        @else
        <p>No se encontraron datos para el ID del alumno especificado.</p>
        @endif
    </div>
</div>
@endsection
