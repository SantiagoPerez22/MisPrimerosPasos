                ...
                <div class="item">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="nivel" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            @can('create nivel')
                            <li class="sidebar-object">
                                <a href="{{ route('niveles.create') }}" class="sidebar-link">Agregar nivel</a>
                            </li>
                            @endcan
                            @can('view nivel')
                            <li class="sidebar-object">
                                <a href="{{ route('niveles.index') }}" class="sidebar-link">Listado de niveles</a>
                            </li>
                            @endcan
                            @can('create sala')
                            <li class="sidebar-object">
                                <a href="{{ route('salas.create') }}" class="sidebar-link">Agregar sala</a>
                            </li>
                            @endcan
                            @can('view sala')
                            <li class="sidebar-object">
                                <a href="{{ route('salas.index') }}" class="sidebar-link">Listado de salas</a>
                            </li>
                            @endcan
                        </ul>
                    </li>
