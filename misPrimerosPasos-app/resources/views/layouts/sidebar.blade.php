            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="cuentas" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-object">
                            <a href="{{ route('users.store') }}" class="sidebar-link">Listado de cuentas</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="tutor" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-object">
                            <a href="{{ route('tutor_alumno.store') }}" class="sidebar-link">Listado de datos</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="rol" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-object">
                            <a href="{{ route('roles.permissions.form') }}" class="sidebar-link">Gestionar Permisos</a>
                        </li>
                        <li class="sidebar-object">
                            <a href="{{ route('roles.users.index') }}" class="sidebar-link">Ver Usuarios y Roles</a>
                        </li>
                        <li class="sidebar-object">
                            <a href="{{ route('roles.permissions.index') }}" class="sidebar-link">Ver Roles y Permisos</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link collapsed" data-bs-target="#domicilio" data-bs-toggle="collapse"
                       aria-expanded="false"><i class="fa-solid fa-indent pe-2"></i>
                        Domicilios
                    </a>
                    <ul id="domicilio" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-object">
                            <a href="{{ route('domicilios.create') }}" class="sidebar-link">Agregar datos</a>
                        </li>
                        <li class="sidebar-object">
                            <a href="{{ route('domicilios.store') }}" class="sidebar-link">Listado de datos</a>
                        </li>
                    </ul>
                </li>
