    ...
    <form action="{{ route('clases.update', $clase->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="id_ambito" class="form-control" id="id_ambito" required>
                ...
                <option value="{{ $ambito->id }}" {{ $ambito->id == $clase->id_ambito ? 'selected' : '' }}>{{ $ambito->nombre }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="id_nucleo" class="form-control" id="id_nucleo" required>
                ...
                <option value="{{ $nucleo->id }}" {{ $nucleo->id == $clase->id_nucleo ? 'selected' : '' }}>{{ $nucleo->nombre }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="id_nivel" class="form-control" id="id_nivel" required>
                ...
                <option value="{{ $nivel->id }}" {{ $nivel->id == $clase->id_nivel ? 'selected' : '' }}>{{ $nivel->nombre }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="id_profesor" class="form-control" id="id_profesor" required>
                ...
                <option value="{{ $user->id }}" {{ $user->id == $clase->id_profesor ? 'selected' : '' }}>{{ $user->name }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="id_asistente1" class="form-control" id="id_asistente1">
                @foreach ($users as $user)
                <option value="{{ $user->id }}" {{ $user->id == $clase->id_asistente1 ? 'selected' : '' }}>{{ $user->name }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="id_asistente2" class="form-control" id="id_asistente2">
                @foreach ($users as $user)
                <option value="{{ $user->id }}" {{ $user->id == $clase->id_asistente2 ? 'selected' : '' }}>{{ $user->name }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="id_sala" class="form-control" id="id_sala" required>
                ...
                <option value="{{ $sala->id }}" {{ $sala->id == $clase->id_sala ? 'selected' : '' }}>{{ $sala->numero }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
